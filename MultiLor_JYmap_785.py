...
bkd_bounds = [700, 950, 1750, 2000] #low wavelength limits (low, high) and high wavelength limits (low, high)

# note width guesses are HWHM not FWHM!
...
NumPksApp = str(NumPeaks)+'Lor'  #keep peak descriptor 3 letters to not have to rewrite summary
