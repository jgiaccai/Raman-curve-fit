...
def EnterData():
    ...
    Gfit = FitGOn*BWF(FitParam[0],FitParam[7],FitParam[14])
...
def FitFunc(x_fit, *EvalSimp):   
    ...
    Gfit = FitGOn*BWF(EvalSimp[0],EvalSimp[7],EvalSimp[14])
...
for file in os.listdir('.'):
    ...
    if fnmatch.fnmatch(file, '*.csv'):
        ...
        Gfit_nom = FitGOn*BWF(fit_results[0],fit_results[7],fit_results[14])
        ...
        f.write("{}\t{}\t{}\n".format('qBWF and avg Corr', qBWF, avgCorr) )
